...
describe('Create2MetadataAwareFactory Test Suite', function () {
  ...
  beforeEach(async function () {
    ...
    create2MetadataAwareFactory = await new Create2MetadataAwareFactoryMock__factory(deployer).deploy() as Create2MetadataAwareFactoryMock;
    tracer.nameTags[create2MetadataAwareFactory.address] = "Create2MetadataAwareFactoryMock";
  });
    ...
    describe('#_deployWithCreate2Metadata', function () {
      ...
      describe('(bytes,bytes32)', function () {
        it('deploys bytecode and returns deployment address initialized with Create2Metadata', async function () {
          ...
          newCreate2MetadataAwareFactory = await ethers.getContractAt("Create2MetadataAwareFactoryMock", address) as Create2MetadataAwareFactoryMock;
