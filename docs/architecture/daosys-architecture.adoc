...
include::{includeprefix}docs/architecture/design_patterns/daosys-design_patterns-00.adoc[leveloffset=+1]

// include::core/daosys-architecture-core-00.adoc[leveloffset=+1]

include::{includeprefix}docs/architecture/interface_hooks/daosys-architecture-interface_hooks-00.adoc[leveloffset=+1]
...
include::{includeprefix}docs/architecture/libraries/daosys-libraries.adoc[leveloffset=+1]

// include::ddsa_types/daosys-architecture-ddsa_types.adoc[leveloffset=+1]

include::{includeprefix}docs/architecture/tests/daosys-test.adoc[leveloffset=+1]