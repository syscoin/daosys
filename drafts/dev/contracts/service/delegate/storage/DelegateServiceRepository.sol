...
} from "contracts/service/delegate/storage/binders/DelegateServiceStorageBinder.sol";
...
library DelegateServiceRepository {
  ...
  function _setDelegateServiceRegistry(
    ...
    DelegateServiceStorageBinder._layout(storageSlotSalt)
  ...
  function _getDelegateServiceRegistry(
    ...
    delegateServiceRegistry = DelegateServiceStorageBinder._layout(storageSlotSalt)
