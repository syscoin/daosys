...
describe('Delegate Service Factory', function () {
  ...
  beforeEach(async function () {
    ...
    expect(
      await delegateServiceFactory.getDelegateServiceRegistry()
  ...
  describe('DelegateServiceFactory', function () {
    ...
    describe("Deploy DelegateService", function () {
      describe("getDelegateServiceRegistry()", function () {
        describe("()", function () {
          it("Reports correct DelegatesServiceRegistry.", async function () {
            expect(
              await delegateServiceFactory.getDelegateServiceRegistry()
            ).to.equal(
      ...
      describe("deployDelegateService.", function () {
        it("(bytes4,bytes)", async function () {
          ...
          const newDelegateService = await delegateServiceFactory
            .callStatic.deployDelegateService(IMessengerInterfaceId, DSCreationCode);
          expect(newDelegateService).to.be.properAddress;

          await delegateServiceFactory.deployDelegateService(IMessengerInterfaceId, DSCreationCode);
