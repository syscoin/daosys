...
describe("Autonomous Service Engine Integration Test Suite", function () {
  ...
  let serviceProxyDelegateServiceAsService: IService;
  ...
  describe("ASE", function () {
    ...
    describe("ASE instantiates platform.", function () {
      ...
      describe("ASE deploys ServiceProxy.", function () {
        ...
        it("ServiceProxy Create2Pedigree initialized correctly.", async function () {
          ...
          //   )
          // ) as IDelegateService;
          serviceProxyDelegateServiceAsService = await ethers.getContractAt(
            "IService",
            await ase.queryDelegateServiceAddress(
              IServiceProxyInterfaceId
            )
          ...
          // const serviceProxyDSServiceDef = await serviceProxyDelegateServiceAsService.getServiceDefs();
          ...
          const serviceProxyDSPedigree = await serviceProxyDelegateServiceAsService.getCreate2Pedigree();
        ...
        it("ServiceProxy ServiceDef initialized correctly.", async function () {
        ...
        it("ServiceProxy Delegate Service Registry initialized correctly.", async function () {
