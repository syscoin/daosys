    ...
    Immutable
{
  ...
  bytes32 internal constant ICREATE2DEPLOYMENTMETADATA_STORAGE_SLOT_SALT = bytes32(type(ICreate2DeploymentMetadata).interfaceId);
  ...
  function initCreate2DeploymentMetadata(
    ...
    isNotImmutable(ICREATE2DEPLOYMENTMETADATA_STORAGE_SLOT_SALT)
