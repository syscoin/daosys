...
// TODO Complete deployment seed mock
...
// {
  ...
  /* -------------------------------------------------------------------------- */
  /*                           Impl metadata functions                          */
  /* -------------------------------------------------------------------------- */

  /* --------------------- IServiceProxy metadata function -------------------- */
  ...
  /* -------------------- ISelectorProxy metadata functions ------------------- */
  ...
  /* -------------- ICreate2DeploymentMetadata metadata function -------------- */
  ...
  /* ------------------- IDelegateService metadata functions ------------------ */
  ...
  /* ------------- IDelegateServiceRegistryAware metadata function ------------ */
