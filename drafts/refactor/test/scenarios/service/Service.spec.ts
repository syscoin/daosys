...
describe("Service Test Suite", function () {
  ...
  const IServiceInterfaceId = "0x01ffc9a7";
  const setDeploymentSaltFunctionSelector = "0x01ffc9a7";
  const getCreate2PedigreeFunctionSelector = '0x2e08c21c';
  const getServiceDefsFunctionSelector = '0xd56eb69e';
  ...
  describe("Service", function () {
    ...
    describe("IERC165 works.", function () {
